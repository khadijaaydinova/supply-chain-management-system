...
public class MarketFormDialog extends JDialog {
    private JTextField nameField, maxCapField, fundsField;
    private boolean saved = false;

    public MarketFormDialog(JFrame parent, Market market) {
        super(parent, market == null ? "Add Market" : "Edit Market", true);
        ...
        nameField = new JTextField(market != null ? market.getName() : "");
        formPanel.add(nameField);

        formPanel.add(new JLabel("Max Capacity:"));
        maxCapField = new JTextField(market != null ? String.valueOf(market.getMaxCapacity()) : "");
        formPanel.add(maxCapField);

        formPanel.add(new JLabel("Funds:"));
        fundsField = new JTextField(market != null ? String.valueOf(market.getFunds()) : "");
